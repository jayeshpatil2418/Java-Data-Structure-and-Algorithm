...
public class CopyArray {
    ...
    public static void main(String[] args) {
        ...
        printArray(arr);
        //Copying array 'arr' to array 'arr_2'
        //Using .clone() method...
        //int arr_2[] = arr.clone();

        //Using Arrays.copyOf(arr_name,length) method...
        //int arr_2[] = Arrays.copyOf(arr,arr.length);

        //Using Arrays.copyOfRange(arr_name,start_index,end_index) method...
        //here, start_index is inclusive while end_index is exclusive...
